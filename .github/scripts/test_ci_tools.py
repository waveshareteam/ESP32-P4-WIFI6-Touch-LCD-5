...
class PackageTests(unittest.TestCase):
    ...
    def test_bundle_has_required_members_identity_ranges_and_hashes(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            self.assertEqual(manifest["chip_revision"], {"minimum": "1.0", "maximum_exclusive": "2.0"})
...
"""
    ...
    def test_48_artifacts_match_direct_project_inventory(self) -> None:
        ...
        self.assertIn("& ./scripts/Flash-CI-Firmware.ps1 -SelfTest", workflow)
        ...
        self.assertIn("rev1_3 = [pscustomobject]@{ Minimum = '1.0'; MaximumExclusive = '2.0' }", flasher)
        self.assertIn("rev3_x = [pscustomobject]@{ Minimum = '3.0'; MaximumExclusive = '4.0' }", flasher)
        self.assertNotIn("rev1_3 = [pscustomobject]@{ Minimum = '1.0'; MaximumExclusive = '3.0' }", flasher)
        self.assertIn('Unsupported ESP32-P4 silicon revision', flasher)
        self.assertIn("'ESP32-P4 rev 2.0'", flasher)
