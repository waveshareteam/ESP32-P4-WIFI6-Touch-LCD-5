...
## Temporary managed-component pin
...
main manifests temporarily pin both components to commit
[`7580ddc989c526678bd7364ece19bfdf1a2745c9`](https://github.com/waveshareteam/Waveshare-ESP32-components/commit/7580ddc989c526678bd7364ece19bfdf1a2745c9)
from the Waveshare component repository, the commit reviewed in upstream
PR [#192](https://github.com/waveshareteam/Waveshare-ESP32-components/pull/192):

- BSP path: `bsp/esp32_p4_wifi6_touch_lcd_5`.
- HX8394 path: `display/lcd/esp_lcd_hx8394`.

This is an exact source pin, not a component-registry release claim. The
`bsp_extra` wrappers in examples 08 and 12 retain their compatible BSP range
`^1.0.1`; they do not override the direct example pin.

## HX8394 initialization boundary

The pinned HX8394 component's standalone default sends its I2C command
...
target board is required before changing or promoting the pin.
