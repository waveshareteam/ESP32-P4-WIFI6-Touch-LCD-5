...
bool Arduino_DSI_Display::begin(int32_t speed)
{
  ...
  {
    // The Waveshare ESP32-P4-WIFI6-Touch-LCD-5 HX8394 panel declares an
    // ACTIVE-HIGH reset (BSP flags.reset_active_high = 1): assert = HIGH,
    // release = LOW. The generic Arduino sequence (active low) would hold
    // the panel in reset forever. Mirror esp_lcd panel_hx8394_reset:
